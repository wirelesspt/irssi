...
my $instrut = 
  ".--------------------------------------------------.-------------------------------------------------.\n".
  "| 1.) /sbar topic remove topic                     | Options:                              Default:  |\n".
  "| 2.) /sbar topic remove topic_empty               |                                                 |\n".
  "| 3.) /sbar topic add -after topicbarstart         | /set twtopic_refresh <speed>          150       |\n".
  "|        -priority 100 -alignment left twtopic     | /set twtopic_size <size>               20       |\n".
  "| 4.) /toggle twtopic_instruct and last /save      | /toggle twtopic_instruct |Startup instructions  |\n".
  "'--------------------------------------------------'-------------------------------------------------'\n";
