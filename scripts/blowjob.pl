...
sub loadconf
{
  my $fconf =Irssi::get_irssi_dir()."/scripts/autorun/blowjob.conf";
  my @conf;
  open (CONF, q{<}, $fconf);
...
Irssi::print("\00314[\00303bl\003090\00303wjob\00314] v$VERSION\00315 script loaded. \00314 Type \00315/blowhelp\00314 for options");
Irssi::print("\00314- paranoia level is      : :\w00315$paranoia");
Irssi::print("\00314- generic key is         : :\00315$key");
Irssi::print("\00314* please read script itself for documentation\n");
